...
*/
             students[i].grade = (students[i].percentage >= 70) ? "A" : (students[i].percentage >= 60) ? "B" : 
                (students[i].percentage >= 50) ? "C" : (students[i].percentage >= 40) ? "Pass" : "Fail";
        ...
        for (int i = 0; i < n; i++) {
            System.out.println(students[i].rno + "\t" + students[i].name + 
                                "\t" + students[i].syTotal + "\t" + students[i].tyTotal + 
                                "\t" + students[i].grandTotal + "\t" + students[i].percentage + "\t" + students[i].grade);
        }
    }
}
